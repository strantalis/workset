...
- Configuration, registered repos, hooks, skills, snapshots.
...
| Workspace/config/registry/registered repos/hooks | Already in `worksetapi` | Add HTTP shim routes over existing methods |
