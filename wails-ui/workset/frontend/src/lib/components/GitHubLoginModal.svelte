<script lang="ts">
  ...
  import {fetchGitHubAuthInfo, openFileDialog, setGitHubAuthMode, setGitHubCLIPath, setGitHubToken} from '../api'
  ...
  let {onClose, onSuccess, notice = null, cancelLabel = 'Cancel'}: Props = $props()
  ...
  {#if mode === 'cli'}
    <div class="code-block">
      ...
      <div class="instructions">
        Workset will use your GitHub CLI session. Run the command in your terminal, then click “Check status”.
      </div>
      <div class="actions">
      ...
      {#if cliMissing}
        <div class="pat-block">
          ...
          <div class="actions">
            ...
            <Button variant="ghost" onclick={browseCLIPath} disabled={loading}>
              Browse…
            </Button>
          </div>
        </div>
