const DEFAULT_TERMINAL_KEYBINDINGS = {
	...
	'terminal.focus_tab_1': ['Alt+1'],
	'terminal.focus_tab_2': ['Alt+2'],
	'terminal.focus_tab_3': ['Alt+3'],
	'terminal.focus_tab_4': ['Alt+4'],
	'terminal.focus_tab_5': ['Alt+5'],
	'terminal.focus_tab_6': ['Alt+6'],
	'terminal.focus_tab_7': ['Alt+7'],
	'terminal.focus_tab_8': ['Alt+8'],
	'terminal.focus_tab_9': ['Alt+9'],
